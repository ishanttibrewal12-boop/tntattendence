...
import { Phone, MapPin, GraduationCap, Award } from 'lucide-react';
    ...
    <section ref={sectionRef} className="py-20 md:py-28" style={{ background: '#10141c' }}>
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-14">
          <p className="text-xs font-bold tracking-[0.25em] uppercase mb-2 text-orange-400">Leadership</p>
          <h2 className="text-3xl md:text-4xl font-extrabold text-white/95">The Minds Behind the Group</h2>
          <div className="w-14 h-0.5 mx-auto mt-4 rounded-full bg-orange-500" />
        ...
        <div className="leader-card rounded-2xl overflow-hidden border border-white/10 mb-8" style={{ background: '#161b26' }}>
          <div className="flex flex-col md:flex-row">
            <div className="md:w-2/5 relative overflow-hidden" style={{ background: '#0F2A44' }}>
              <img src={founderPhoto} alt="Sunil Tibrewal" className="w-full h-64 md:h-full object-cover object-top" loading="lazy" />
            ...
            <div className="md:w-3/5 p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-2 text-xs text-white/45">
                <MapPin className="h-3.5 w-3.5" /> Jharkhand, India
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="leader-card rounded-2xl overflow-hidden border border-white/10" style={{ background: '#161b26' }}>
          <div className="flex flex-col md:flex-row-reverse">
            <div className="md:w-2/5 relative overflow-hidden" style={{ background: '#0F2A44' }}>
              <img src={proprietorPhoto} alt="Trishav Tibrewal" className="w-full h-64 md:h-full object-cover object-top" loading="lazy" />
            ...
            <div className="md:w-3/5 p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4 text-xs text-white/45">
                <a href="tel:9386469006" className="flex items-center gap-1.5 hover:text-white/70 transition-colors">
                  <Phone className="h-3.5 w-3.5" /> 9386469006
                </a>
        ...
        {/* Vision Quote */}
        <div className="leader-card mt-8 rounded-2xl border border-white/10 p-6 md:p-10 relative overflow-hidden" style={{ background: '#161b26' }}>
          ...
          <div className="flex items-center gap-4 mb-6">
            <img src={proprietorPhoto} alt="Trishav Tibrewal" className="w-12 h-12 rounded-full object-cover border-2 border-orange-500" />
            <div>
