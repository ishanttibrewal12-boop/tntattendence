  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100svh] flex items-center overflow-hidden">
      ...
      <div ref={contentRef} className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 py-20 will-change-transform">
        ...
        />
        <h1 className="hero-title text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 leading-tight text-white">
          TIBREWAL GROUP
        </h1>
        <p className="hero-subtitle text-lg md:text-xl font-medium mb-8 text-white/70">
